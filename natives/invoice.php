...
class ProdukFisik extends Produk {
    ...
    public function __construct(string $nama, float $harga, int $stok, float $beratKg, float $biayaKirim) {
...
class ProdukDigital extends Produk {
    ...
    public function __construct(string $nama, float $harga, int $stok, string $formatFile, string $lisensi) {
        parent::__construct($nama, $harga, $stok);
